...
// tk và mk của wifi-------------------------start
const char* ssid1 = "name123";
const char* password1 = "918273555";
const char* ssid2 = "iPhone";
const char* password2 = "ok123456";
// tk và mk của wifi---------------------------end
// hot and topic-----------------------------start
...
#define topic_sub2 "dien_lanh"// quạt
#define topic_sub3 "am_thanh"// còi
